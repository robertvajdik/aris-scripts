...
CockpitHelper.prototype.getCustomerInteractionPointFolder = function (corporateKey) {
    return this.getCockpitChildText(corporateKey, "customerTouchPoint");
}

CockpitHelper.prototype.getNewCustomerInteractionPointFolder = function (corporateKey) {
    return this.getCockpitChildText(corporateKey, "newCustomerTouchPoint");
}
