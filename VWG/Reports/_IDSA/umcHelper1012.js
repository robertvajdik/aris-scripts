...
function writeTableCellCenter(text, width, isEvenRow) {
    if(!width) width = 20;
    bgcolor = Constants.C_WHITE;
    if(isEvenRow) bgcolor = setColor(242,242,242);
    g_Output.TableCell(text, width, getString("ID_DEFAULT_FONT"), 10, Constants.C_BLACK, bgcolor, 0, Constants.FMT_VTOP | Constants.FMT_CENTER, 0);
}
